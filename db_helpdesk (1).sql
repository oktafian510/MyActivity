...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Des 2022 pada 04.05
...
CREATE TABLE `status_tiket` (
  ...
  `STATUS_TIKET` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tiket` (
  ...
  `SUB_MASALAH` varchar(60) NOT NULL,
...
CREATE TABLE `tiket_detail` (
  `ID_TIKET_DETAIL` int(255) NOT NULL,
  `ID_TIKET` varchar(255) NOT NULL,
...
--
ALTER TABLE `tiket_detail`
  MODIFY `ID_TIKET_DETAIL` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
...
ALTER TABLE `tiket_detail`
  ...
  ADD CONSTRAINT `tiket_detail_ibfk_2` FOREIGN KEY (`ID_TIKET`) REFERENCES `tiket` (`ID_TIKET`),
